...
import { USE_MIDDLAWARE_METADATA_KEY } from "../constants/metadata_keys/use_middlaware";

export type UseMiddlawareDefine = [string | symbol, ClassConstructor];

export function UseMiddlaware<T extends ClassConstructor>(middlaware: T, canCancel?: boolean): MethodDecorator {
